 ...
 * Class: CMPS 12B
 * Date: Oct 29, 2014
 * Filename: CalTest.java
 * Description: Unit test for Calc.java
 */
...
public class CalcTest {
    ...
    @Test
    public void compundExpressionTest(){
	Calc c = new Calc();
	c.push(5.0);
	c.push(20.0);
	c.push(5.0);
	...
	c.add();
	c.add();
	assertEquals(75.0, c.pop(), EPSILON);

}

   @Test
   public void compoundExpressionDepthPeakTest(){
	Calc c = new Calc();
	c.push(5.0);
	c.push(20.0);
	c.push(5.0);
	...
	c.divide();
	c.multiply();
	assertEquals(50.0, c.peek(), EPSILON);
   ...
   public void reciprocalTest(){
	...
	c.push(5.0);
	c.reciprocal();
	assertEquals((1.0)/(5.0), c.pop(), EPSILON);
}
